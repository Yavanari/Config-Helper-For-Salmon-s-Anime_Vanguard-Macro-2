...
1. Click on **Create gamemode folders** button 
...
5. Select **Extracted config folder** in config folder menu to search configs only in this folder(default means the ImportConfigs folder, use this only if the config you donwloaded contains only .txt files)
6. Select **Gamemode , Map , Team** (Select Team only if original config had Team.txt in it)
7. Click Import Button
8. After importing **Config folder** will be deleted
9. **Default Strategy** button will import universal default strategy from AIO V1 (made by :@knownaszad)


# How to use as config maker
1. Select **Gamemode , Map , Team you want to export**
2. Click **Export** button
3. Exported config will be saved in **ExportConfig** folder
